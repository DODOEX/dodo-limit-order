...
import {ISIGMAXApproveProxy} from "./intf/ISIGMAXApproveProxy.sol";
import {IERC1271Wallet} from "./intf/IERC1271Wallet.sol";
import {InitializableOwnable} from "./lib/InitializableOwnable.sol";
import "./lib/ArgumentsDecoder.sol";

/**
 * @title SIGMAXLimitOrder
 * @author SIGMAX team
 */
contract SIGMAXLimitOrder is EIP712("SIGMAX Limit Order Protocol", "1"), InitializableOwnable, ReentrancyGuard {
    ...
    address public _SIGMAX_APPROVE_PROXY_;
    ...
    function init(address owner, address sigmaxApproveProxy, address feeReciver) external {
        initOwner(owner);
        _SIGMAX_APPROVE_PROXY_ = sigmaxApproveProxy;
    ...
    function fillLimitOrder(
        ...
        //Maker => Taker
        ISIGMAXApproveProxy(_SIGMAX_APPROVE_PROXY_).claimTokens(order.makerToken, order.maker, msg.sender, curMakerFillAmount);
